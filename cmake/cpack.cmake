...
IF (${IS_RELEASE}) # we are building for a release (tag) version of SAC2C
  SET (CPACK_PACKAGE_FILE_NAME         "${CPACK_PACKAGE_NAME}-${PROJECT_SHORT_VERSION}-for-${SAC2C_VERSION}")
ELSE ()
  SET (CPACK_PACKAGE_FILE_NAME         "${CPACK_PACKAGE_NAME}-${PROJECT_SHORT_VERSION}")
ENDIF ()
